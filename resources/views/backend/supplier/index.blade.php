                        ...
                        <div class="col-12 col-md-6">
                            <div class="form-group">
                                <label for="sku_no">
                                    <span @class('text-danger')>*</span>
                                    SKU No</label>
                                <input @class(['form-control',]) type="text" title="Product Bar Code" id="sku_no"
                                    placeholder="Sku No" name="sku_no">
                                    <a href="javascript:void(0)" onclick="GenrateCode()" class="text-green">Generate Code</a>
                                    <br>
                                    <span @class(['text-danger','error_msg'])  id="error_sku"></span>
                            </div>
                        </div>
                        <div class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <input @class(['form-control',]) type="text" title="Product Purchase Rate"
                                    ...
                                    <span @class(['text-danger','error_msg'])  id="error_purchase"></span>
                            </div>
                        </div>
                        <div class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <input @class(['form-control',]) type="text" title="Product Sale Rate" id="sale_rate"
                                    ...
                                    <span @class(['text-danger','error_msg'])  id="error_sale"></span>
                            </div>
                        </div>
                        <div class="col-12 col-md-6">
                            <div class="form-group">
